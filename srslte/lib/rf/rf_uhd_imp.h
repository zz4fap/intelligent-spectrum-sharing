...
#define SCATTER_SAMPLES_TO_READ 768 // This value is equivalent to the size of 2 OFDM symbols for 5 MHz BW.
...
SRSLTE_API double rf_uhd_set_tx_srate(void *h, double freq, size_t channel);
